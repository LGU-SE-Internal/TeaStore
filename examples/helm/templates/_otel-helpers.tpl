...
instrumentation.opentelemetry.io/inject-{{ .Values.opentelemetry.language }}: "{{ .Values.opentelemetry.monitoringNamespace }}/{{ .Values.opentelemetry.instrumentationName }}"
{{- end }}
{{- end }}
